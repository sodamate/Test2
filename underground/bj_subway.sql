...
-- ----------------------------
-- Table structure for bj_subway
-- ----------------------------
DROP TABLE IF EXISTS `bj_subway`;
CREATE TABLE `bj_subway`  (
  `station_id` int(0) NOT NULL,
  `line_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `station_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `next_station` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
